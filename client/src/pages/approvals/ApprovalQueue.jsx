...
const ApprovalQueue = () => {
  ...
  const { data, pagination, loading, setPage, setSearch, setParams } = useFetch(getApprovals, {
  ...
  return (
    <div>
      <PageHeader title="Approval Queue" subtitle="Review and manage approval requests" />
